...
<div class="page">
	...
	<section class="content">
		...
		<div class="postlist postlist-details">
			<div class="post-media large-image">
				<div class="post-image" style="background-image: url(images/temp/post-details-11.jpg)"></div><!--Image 1920x710-->
			</div>
				...
				<div class="row">
					<div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
						...
						<article class="post-details post-details-single" itemscope itemtype="http://schema.org/Article">
							...
							<h1 class="post-title" itemprop="name">Large Image Blog Post</h1>
							<div class="post-subtitle">This is a secondary article title or subcaption. It could be on either one or two lines and highlight something important about the article.</div>
							...
							<div class="post-content" itemprop="articleBody">
								...
								<blockquote class="blockquote">Lorem quis bibendum auctor nisi consequat ipsum nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris morbi et accumsan ipsum velit.</blockquote>
								<p>Aenean sollicitudin lorem quis bibendum auctor nisi consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh <a href="#">vulputate cursus</a> a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis <a href="#">dapibus condimentum</a> sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi. Proin condimentum fermentum nunc. Etiam pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Suspendisse in orci enim.</p>
							</div>
