...
<div class="page">
	...
	<section class="content">
		<!-- PostList -->
		<div class="postlist postlist-details postlist-image" style="background-image: url(images/temp/content-bg.jpg);"><!--Image 1920x3929-->
						...
						<div class="postlist-inner">
							...
							<article class="post-details post-details-single" itemscope itemtype="http://schema.org/Article">
								...
								<div class="post-media">
									<img src="images/temp/post-details-9.jpg" alt="" itemprop="image"/><!--Image 930x520-->
								</div>

								<h1 class="post-title" itemprop="name">Post with Image Background</h1>
