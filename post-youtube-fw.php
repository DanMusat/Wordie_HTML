				...
				<div class="row">
					<div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
						...
						<article class="post-details post-details-single" itemscope itemtype="http://schema.org/Article">
							...
							<h1 class="post-title" itemprop="name">Youtube Video Post with SideBar Comments</h1>

							<div class="post-media">
								<iframe itemprop="video" class="video-player" width="1920" height="1080" src="https://www.youtube.com/embed/LvGKhtGLo4A" allowfullscreen></iframe>
							</div>
